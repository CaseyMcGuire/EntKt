...
object SchemaInspector {
    ...
    fun validate(inputs: List<SchemaInput>): ValidationResult {
        ...
        // [runMemberCollisionCheck] so direct codegen callers
        // that bypass this inspector still get the check.
     ...
     * exactly one explicitly named FK column, optionally backed by `.field(handle)`.
     */

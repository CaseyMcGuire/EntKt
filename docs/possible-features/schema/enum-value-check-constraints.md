...
- **Not** native PostgreSQL `ENUM` types or `ALTER TYPE … RENAME VALUE`.
  ...
  foundation in [Native Database Column Types](../../02-schema.md#native-column-types-postgres-pgvector).
...
- **Native PostgreSQL enum types.** Stronger typing and `ALTER TYPE …
  ...
  [Native Database Column Types](../../02-schema.md#native-column-types-postgres-pgvector).

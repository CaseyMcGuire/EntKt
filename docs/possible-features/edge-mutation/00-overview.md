...
The collision work has landed first as RFC 07 V1 so that declaration-name
capture (RFC 06) emits actionable diagnostics rather than Kotlin compile
errors when new generated names overlap existing schema members.
